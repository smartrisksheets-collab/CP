...
const S = {
  ...
  statVal  : { fontSize:18, fontWeight:700, color:"var(--accent)", fontFamily:"Georgia, serif" },
  ...
  heading  : { fontSize:30, fontWeight:700, color:"#1a1a2e", marginBottom:8, fontFamily:"Georgia, serif" },
