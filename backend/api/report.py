...
_CURRENCY_FONT_BOLD = "UniFont-Bold" if _HAS_UNIFONT else "Helvetica-Bold"
...
def _ST():
    ...
    return {
        ...
        "cp_val"   : ps("cp_val",   fontSize=9,  textColor=C_NAVY, fontName=_CURRENCY_FONT_BOLD, leading=11),
...
def _build_elements(assessment: Assessment):
    ...
    disc_style = ParagraphStyle("disc", fontName=_CURRENCY_FONT, fontSize=6.5, leading=9,
                                textColor=C_GREY, alignment=TA_LEFT)
